...
model_file = os.path.join(package_directory, 'models/v2')
    ...
    for player_pos in range(num_players):
        ...
        for _ in range(num_episodes):
            ...
            while not time_step.last():
                ...
                replaceInfoStateWithDBN(time_step)  # get dbn information out of the observation
...
def main(_):
    ...
    info_state_size = len(game.new_initial_state().dbn_string())
    ...
    agents = [
        dqn_v2.DQN(
            ...
            epsilon_decay_duration=int(3e5),
    ...
    for ep in range(FLAGS.num_train_episodes):
        ...
        while not time_step.last():
            ...
            replaceInfoStateWithDBN(time_step)
            if env.is_turn_based:
...
def replaceInfoStateWithDBN(time_step):
    # get dbn information out of the observation
    ...
    time_step.observations["info_state"] = [dbn for i in range(2)]
